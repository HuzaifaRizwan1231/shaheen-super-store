    ...
    <div class="container h-100 py-5">
        <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class='card-body p-4'>
                        <div class='row d-flex align-items-center'>
                            <div class='col-md-2 col-2 text-center'>
                                <h5 class='mb-0 ProductInCart'><b>$brand_id</b></h5>
                            </div>
                            <div class='col-md-6 col-5 text-center'>
                                <h5 class='mb-0 ProductInCart'><b>$brand_name</b></h5>
            ...
            <div class="col-md-12 mt-4 text-center">
                <button class="SubmitButton shiftButton w-75" type="button"><a href="index.php?shift_brand_of_products"
